    ...
    <div className="responsive-sm space-y-10 py-14">
      ...
      <ul className="list-disc list-inside text-base-200">
        <li className="text-base text-base-200">
          <p className="text-base-400">
            <strong className="text-white">Personal Information:</strong> We may collect certain personally identifiable
            information, such as your name, email address, and phone number when you voluntarily provide it to us.
          </p>
        </li>
        <li className="text-base text-base-200">
          <p className="text-base-400">
            <strong className="text-white">Usage Information:</strong> We may collect information about how you interact
            with our services, including your IP address, device information, and browsing activity.
          </p>
        </li>
      </ul>
      <h2 className="text-3xl font-bold">Use of Information</h2>
      <p className="text-base-400">We may use the collected information for the following purposes:</p>
      <ul className="list-disc list-inside text-base-200">
